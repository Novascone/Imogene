...
public partial class EffectTest : Ability
{
	...
	[Export] public string effect_scene_string;
	public PackedScene effect_scene;
	...
	public override void _Ready()
	{
		...
		hitbox_to_load = GD.Load<PackedScene>("res://scripts/abilities/General/Active/EffectTest/EffectTestHitbox.tscn");
		mesh_to_load = GD.Load<PackedScene>("res://scripts/abilities/General/Active/EffectTest/EffectTestMesh.tscn");

		effect_scene = GD.Load<PackedScene>(effect_scene_string);
