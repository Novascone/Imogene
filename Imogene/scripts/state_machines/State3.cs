        ...
        for(int i = 0; i < entity.num_rays; i++)
            {
                ...
                var d = entity.ray_directions[i].Rotated(entity.GlobalTransform.Basis.Y.Normalized(), entity.Rotation.Y).Dot(entity.Transform.Basis.X + entity.GlobalPosition.DirectionTo(target_position)); 
